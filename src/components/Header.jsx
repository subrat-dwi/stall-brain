export default function Header() {
  return (
    <header className="relative overflow-hidden rounded-3xl border border-(--color-border) bg-[radial-gradient(circle_at_top,#1a1400,#0D0D0D)] px-6 py-8 shadow-2xl shadow-black/40">
      <div className="absolute -top-24 right-6 h-40 w-40 rounded-full bg-[rgba(245,158,11,0.22)] blur-3xl" />
      <div className="absolute -bottom-20 left-10 h-40 w-40 rounded-full bg-[rgba(74,222,128,0.12)] blur-3xl" />
